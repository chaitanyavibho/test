                ...
                <div class="d-flex">
                    ...
                    <div class="navbar-brand-box">
                        ...
                        <a href="index.html" class="logo logo-light">
                            <span class="logo-sm">
                                <img src="assets/images/logo.svg" alt="" width="30px">
                            </span>
                            <span class="logo-lg">
            ...
            <div data-simplebar class="h-100">
                ...
                <div id="sidebar-menu">
                    ...
                    <ul class="metismenu list-unstyled" id="side-menu">
						...
						<li>
                            <a href="{{ url('relation') }}" class=" waves-effect">
						...
						<li>
                            <a href="{{ url('order_old') }}" class=" waves-effect">
                                <i class="ti-receipt"></i>
                                <span>Bookings</span>
                            </a>
                        </li>
						<li style="display:none;">
                            <a href="{{ url('seva') }}" class=" waves-effect">
                                <i class="ti-user"></i>
                                <span>Sevas</span>
                            </a>
                        </li>
						<li>
                            <a href="{{ url('temple') }}" class=" waves-effect">
                                <i class="ti-receipt"></i>
                                <span>Temples</span>
                            </a>
                        </li>
						<li>
                            <a href="{{ url('rasi') }}" class=" waves-effect">
                                <i class="ti-receipt"></i>
                                <span>Rasi</span>
                            </a>
                        </li>
